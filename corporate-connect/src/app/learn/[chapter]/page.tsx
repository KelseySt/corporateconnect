        ...
        {cirriculum[0].modules.map((e) => {
          return (
            <Card key={e.key} className="bg-lpurple p-3 rounded-2xl">
              <CardHeader className=" py-2 px-4 flex-col items-start"></CardHeader>
              <CardBody className="overflow-visible py-2">
                <div className="grid grid-cols-2">
                  ...
                  <div className="ml-2">
                    ...
                    <p>{e.desc}</p>
                    <Button
                      className="block bg-white rounded-xl p-4 my-2"
                      onPress={() => router.push(`/learn/${uid}/${e.key}`)}
                    >
                      Lesson - <span className="font-bold">20pts</span>
                    </Button>
                    <Button
                      className="block bg-white rounded-xl p-4 my-2"
                      onPress={() => router.push(`/learn/${uid}/${e.key}/1`)}
                    >
                      Quiz 1 - <span className="font-bold">10pts</span>
                    </Button>
                    <Button
                      className="block bg-white rounded-xl p-4 "
                      onPress={() => router.push(`/learn/${uid}/${e.key}/2`)}
                    >
